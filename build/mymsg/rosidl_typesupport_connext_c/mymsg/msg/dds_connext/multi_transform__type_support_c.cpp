...
#include "mymsg/msg/multi_transform__rosidl_typesupport_connext_c.h"
...
static DDS_TypeCode *
_MultiTransform__get_type_code()
{
  return mymsg::msg::dds_::MultiTransform_TypeSupport::get_typecode();
}

static bool
_MultiTransform__convert_ros_to_dds(const void * untyped_ros_message, void * untyped_dds_message)
{
  ...
  const mymsg__msg__MultiTransform * ros_message =
    static_cast<const mymsg__msg__MultiTransform *>(untyped_ros_message);
  mymsg::msg::dds_::MultiTransform_ * dds_message =
    static_cast<mymsg::msg::dds_::MultiTransform_ *>(untyped_dds_message);
  // Member name: transform
  {
    const message_type_support_callbacks_t * mymsg__msg__Transform__callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_connext_c, mymsg, msg, Transform
      )()->data);
    ...
    for (DDS_Long i = 0; i < static_cast<DDS_Long>(size); ++i) {
      auto & ros_i = ros_message->transform.data[i];
      if (!mymsg__msg__Transform__callbacks->convert_ros_to_dds(
          &ros_i, &dds_message->transform_[i]))
      {
        return false;
      }
    }
...
static bool
_MultiTransform__convert_dds_to_ros(const void * untyped_dds_message, void * untyped_ros_message)
{
  if (!untyped_ros_message) {
    fprintf(stderr, "ros message handle is null\n");
    return false;
  ...
  const mymsg::msg::dds_::MultiTransform_ * dds_message =
    static_cast<const mymsg::msg::dds_::MultiTransform_ *>(untyped_dds_message);
  mymsg__msg__MultiTransform * ros_message =
    static_cast<mymsg__msg__MultiTransform *>(untyped_ros_message);
  // Member name: transform
  {
    DDS_Long size = dds_message->transform_.length();
    ...
    for (DDS_Long i = 0; i < size; i++) {
      ...
      callbacks->convert_dds_to_ros(&dds_message->transform_[i], &ros_i);
    }
  }
  return true;
}
...
static bool
_MultiTransform__to_cdr_stream(
  ...
  rcutils_uint8_array_t * cdr_stream)
{
  ...
  const mymsg__msg__MultiTransform * ros_message =
    static_cast<const mymsg__msg__MultiTransform *>(untyped_ros_message);
  mymsg::msg::dds_::MultiTransform_ dds_message;
  if (!_MultiTransform__convert_ros_to_dds(ros_message, &dds_message)) {
    return false;
  }
  ...
  void * untyped_ros_message)
{
  ...
  bool success = _MultiTransform__convert_dds_to_ros(dds_message, untyped_ros_message);
...
static message_type_support_callbacks_t _MultiTransform__callbacks = {
  ...
  "MultiTransform",  // message_name
  _MultiTransform__get_type_code,  // get_type_code
  _MultiTransform__convert_ros_to_dds,  // convert_ros_to_dds
  _MultiTransform__convert_dds_to_ros,  // convert_dds_to_ros
  _MultiTransform__to_cdr_stream,  // to_cdr_stream
  _MultiTransform__to_message  // to_message
};
