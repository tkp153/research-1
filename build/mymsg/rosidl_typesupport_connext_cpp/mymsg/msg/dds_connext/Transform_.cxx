...
namespace mymsg {
    namespace msg {
        namespace dds_ {
            ...
            /* ========================================================================= */
            const char *Transform_TYPENAME = "mymsg::msg::dds_::Transform_";

            DDS_TypeCode* Transform__get_typecode()
            {
                static RTIBool is_initialized = RTI_FALSE;

                static DDS_TypeCode_Member Transform__g_tc_members[1]=
                {
                ...
                {{
                        ...
                        -1, /*Ignored*/
                        (char *)"mymsg::msg::dds_::Transform_", /* Name */
                        NULL, /* Ignored */      
                        0, /* Ignored */
                        0, /* Ignored */
                        NULL, /* Ignored */
                ...
                Transform__g_tc_members[0]._representation._typeCode = (RTICdrTypeCode *)geometry_msgs::msg::dds_::Transform__get_typecode();
            ...
            RTIBool Transform__initialize(
                Transform_* sample) {
                return mymsg::msg::dds_::Transform__initialize_ex(sample,RTI_TRUE,RTI_TRUE);
            }
                ...
                Transform_* sample,RTIBool allocatePointers, RTIBool allocateMemory)
            {
                ...
                return mymsg::msg::dds_::Transform__initialize_w_params(
                    sample,&allocParams);
                ...
                Transform_* sample)
            {
                ...
                mymsg::msg::dds_::Transform__finalize_ex(sample,RTI_TRUE);
            }
                ...
                Transform_* sample,RTIBool deletePointers)
            {
                ...
                mymsg::msg::dds_::Transform__finalize_w_params(
            ...
            */
            ...
            #define T_initialize_w_params mymsg::msg::dds_::Transform__initialize_w_params

            #define T_finalize_w_params   mymsg::msg::dds_::Transform__finalize_w_params
            #define T_copy       mymsg::msg::dds_::Transform__copy
