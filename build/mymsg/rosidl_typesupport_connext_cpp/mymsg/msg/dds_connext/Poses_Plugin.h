...
#ifndef Poses_Plugin_215316047_h
#define Poses_Plugin_215316047_h
...
namespace mymsg {
    namespace msg {
        namespace dds_ {
            ...
            #define Poses_Plugin_get_sample PRESTypePluginDefaultEndpointData_getSample 
            #define Poses_Plugin_get_buffer PRESTypePluginDefaultEndpointData_getBuffer 
            #define Poses_Plugin_return_buffer PRESTypePluginDefaultEndpointData_returnBuffer 

            #define Poses_Plugin_create_sample PRESTypePluginDefaultEndpointData_createSample 
            #define Poses_Plugin_destroy_sample PRESTypePluginDefaultEndpointData_deleteSample 

            /* --------------------------------------------------------------------------------------
            Support functions:
            * -------------------------------------------------------------------------------------- */

            NDDSUSERDllExport extern Poses_*
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            NDDSUSERDllExport extern RTIBool 
            Poses_Plugin_deserialize_key_sample(
                PRESTypePluginEndpointData endpoint_data,
                Poses_ * sample,
                struct RTICdrStream *stream,
                RTIBool deserialize_encapsulation,
            ...
            Poses_Plugin_new(void);

            NDDSUSERDllExport extern void
            Poses_Plugin_delete(struct PRESTypePlugin *);
...
#endif /* Poses_Plugin_215316047_h */
