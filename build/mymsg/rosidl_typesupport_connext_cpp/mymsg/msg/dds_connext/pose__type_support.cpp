...
#include "mymsg/msg/pose__rosidl_typesupport_connext_cpp.hpp"
  ...
  mymsg::msg::dds_::Pose_ & dds_message)
{
  // member.name keypoints
  {
    ...
    for (size_t i = 0; i < size; i++) {
      dds_message.keypoints_[static_cast<DDS_Long>(i)] =
  ...
  mymsg::msg::Pose & ros_message)
{
  // member.name keypoints
  {
    size_t size = dds_message.keypoints_.length();
  ...
  rcutils_uint8_array_t * cdr_stream)
{
  ...
  const mymsg::msg::Pose & ros_message =
    *(const mymsg::msg::Pose *)untyped_ros_message;

  // create a respective connext dds type
  mymsg::msg::dds_::Pose_ * dds_message = mymsg::msg::dds_::Pose_TypeSupport::create_data();
  if (!dds_message) {
    return false;
  }
  ...
  void * untyped_ros_message)
{
  ...
  mymsg::msg::Pose & ros_message =
    *(mymsg::msg::Pose *)untyped_ros_message;
...
{
  return &mymsg::msg::typesupport_connext_cpp::_Pose__handle;
}
