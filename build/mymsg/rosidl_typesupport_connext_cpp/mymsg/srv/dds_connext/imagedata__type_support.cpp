  ...
  mymsg::srv::dds_::Imagedata_Request_ & dds_message)
{
  ...
  if (
    !sensor_msgs::msg::typesupport_connext_cpp::convert_ros_message_to_dds(
      ...
      dds_message.input_data_))
  {
    return false;
  }

  // member.name input_count
  dds_message.input_count_ =
    ros_message.input_count;
  ...
  rcutils_uint8_array_t * cdr_stream)
{
  ...
  const mymsg::srv::Imagedata_Request & ros_message =
    *(const mymsg::srv::Imagedata_Request *)untyped_ros_message;

  // create a respective connext dds type
  mymsg::srv::dds_::Imagedata_Request_ * dds_message = mymsg::srv::dds_::Imagedata_Request_TypeSupport::create_data();
  if (!dds_message) {
    return false;
  }
  ...
  void * untyped_ros_message)
{
  ...
  mymsg::srv::Imagedata_Request & ros_message =
    *(mymsg::srv::Imagedata_Request *)untyped_ros_message;
...
{
  return &mymsg::srv::typesupport_connext_cpp::_Imagedata_Request__handle;
}
  ...
  mymsg::srv::dds_::Imagedata_Response_ & dds_message)
{
  ...
  dds_message.output_cut_ =
    ros_message.output_cut;

  // member.name output_count
  dds_message.output_count_ =
    ros_message.output_count;

  // member.name output_data
  if (
    !sensor_msgs::msg::typesupport_connext_cpp::convert_ros_message_to_dds(
      ros_message.output_data,
      dds_message.output_data_))
  {
    return false;
  }
  ...
  mymsg::srv::Imagedata_Response & ros_message)
{
  // member.name output_cut
  ros_message.output_cut =
    dds_message.output_cut_ == DDS_BOOLEAN_TRUE;
  ...
  rcutils_uint8_array_t * cdr_stream)
{
  ...
  // cast the untyped to the known ros message
  const mymsg::srv::Imagedata_Response & ros_message =
    *(const mymsg::srv::Imagedata_Response *)untyped_ros_message;

  // create a respective connext dds type
  mymsg::srv::dds_::Imagedata_Response_ * dds_message = mymsg::srv::dds_::Imagedata_Response_TypeSupport::create_data();
  if (!dds_message) {
    return false;
  }
  ...
  void * untyped_ros_message)
{
  ...
  mymsg::srv::Imagedata_Response & ros_message =
    *(mymsg::srv::Imagedata_Response *)untyped_ros_message;
  bool success = convert_dds_message_to_ros(*dds_message, ros_message);
  if (mymsg::srv::dds_::Imagedata_Response_TypeSupport::delete_data(dds_message) != DDS_RETCODE_OK) {
    return false;
  }
...
{
  return &mymsg::srv::typesupport_connext_cpp::_Imagedata_Response__handle;
}
...
void * create_requester__Imagedata(
...
const char * destroy_requester__Imagedata(
...
int64_t send_request__Imagedata(
  void * untyped_requester,
  const void * untyped_ros_request)
{
  using ROSRequestType = mymsg::srv::Imagedata_Request;
  using RequesterType = connext::Requester<
    mymsg::srv::dds_::Imagedata_Request_,
    mymsg::srv::dds_::Imagedata_Response_
  >;
  connext::WriteSample<
    mymsg::srv::dds_::Imagedata_Request_> request;
  const ROSRequestType & ros_request = *(
    static_cast<const ROSRequestType *>(untyped_ros_request));
  mymsg::srv::typesupport_connext_cpp::convert_ros_message_to_dds(
...
void * create_replier__Imagedata(
  void * untyped_participant,
  const char * request_topic_str,
  const char * response_topic_str,
  const void * untyped_datareader_qos,
...
const char * destroy_replier__Imagedata(
  ...
  void * untyped_ros_request)
{
  ...
  bool converted =
    mymsg::srv::typesupport_connext_cpp::convert_dds_message_to_ros(request.data(), ros_request);
  if (!converted) {
    return false;
  }
  ...
  void * untyped_ros_response)
{
  using RequesterType = connext::Requester<
    ...
    mymsg::srv::dds_::Imagedata_Response_
  >;
  using ROSResponseType = mymsg::srv::Imagedata_Response;
  ...
  bool converted =
    mymsg::srv::typesupport_connext_cpp::convert_dds_message_to_ros(response.data(), ros_response);
  return converted;
}
...
{
  using ROSResponseType = const mymsg::srv::Imagedata_Response;
  using ReplierType = connext::Replier<
    mymsg::srv::dds_::Imagedata_Request_,
    mymsg::srv::dds_::Imagedata_Response_
  >;
  ...
  bool converted =
    mymsg::srv::typesupport_connext_cpp::convert_ros_message_to_dds(ros_response, response.data());
  if (!converted) {
    return false;
  }
...
{
  return &mymsg::srv::typesupport_connext_cpp::_Imagedata__handle;
}
